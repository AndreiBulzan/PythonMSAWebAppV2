...
textNrFact=tk.Label( text='Nr. fact: ' + str(nrFactJson))
textNrFact.pack()
textDataFact=tk.Label( text='Data facturii: ' + str(dataJson))
textDataFact.pack()
if len(cifOrCnpJson)>=1:
	textCif1=tk.Label( text='CIF 1: ' + str(cifOrCnpJson[0]))
	textCif1.pack()
if len(cifOrCnpJson)>=2:
	textCif2=tk.Label( text='CIF 2: ' + str(cifOrCnpJson[1]))
	textCif2.pack()
textPret=tk.Label( text='\nPreț: ' + str(pretJson))
textPret.pack()
textTVA=tk.Label( text='TVA: ' + str(tvaJson))
textTVA.pack()
textTotal=tk.Label( text='Total: ' + str(totalJson))
textTotal.pack()

	
	
f1 = open("myOutput.txt", "w")
f1.write("------------------------\n")
